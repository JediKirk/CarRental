            ...
            <div class="main__content--register">
                <form action="/CarRental_war_exploded/admin/cars/create-car" method="post">
                    <div class="container">
                        ...
                        <input type="text" placeholder="Введите номер автомобиля" name="registeredCarNumber" autocomplete="text">
                        ...
                        <input type="text" placeholder="Введите брэнд автомобиля" name="brand" autocomplete="text">
                        ...
                        <input type="text" placeholder="Введите цену ареды за день" name="rentalDayPrice" autocomplete="text">
