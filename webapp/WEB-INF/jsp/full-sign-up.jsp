    ...
    <div class="main__content">
        <div class="main__content__header">
            ...
            <div class="main__content__header--links">
                <div class="links">
                    <div class="button back"><a href="./register.html">&lsaquo;</a></div>
                    <div class="button login"><a href="login.html">Вход</a></div>
                </div>
            </div>
        </div>
        <div class="main__content--register">
            <form action="/CarRental_war_exploded/registration/full-sign-up" method="post">
                <div class="container">
                    ...
                    <input id="date" type="text" placeholder="Введите год рождения" name="dateOfBirth"
                           autocomplete="text">

                    <label><b>Пол</b></label>
                    <input type="text" placeholder="Введите пол" name="gender">
